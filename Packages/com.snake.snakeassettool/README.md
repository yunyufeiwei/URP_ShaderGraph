...
<root>
  ...
  ├── Editor
  │   ├── GebilaowxjOutlook.Snakeassettool.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── GebilaowxjOutlook.Snakeassettool.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── GebilaowxjOutlook.Snakeassettool.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── GebilaowxjOutlook.Snakeassettool.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `GebilaowxjOutlook.Snakeassettool`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package SnakeAssetTool Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/GebilaowxjOutlook.Snakeassettool.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/GebilaowxjOutlook.Snakeassettool.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/GebilaowxjOutlook.Snakeassettool.Editor.Tests.asmdef`

  `Tests/Runtime/GebilaowxjOutlook.Snakeassettool.Tests.asmdef`
...
Use the `Documentations~/SnakeAssetTool.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
